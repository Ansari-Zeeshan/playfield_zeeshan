const openContainer = document.querySelectorAll('#home .select-box .selected');
const tabBtn = document.querySelectorAll('.playfield_overview .btnDiv p');
const select = document.querySelectorAll('#home .search-box input');
const optContainer = document.querySelectorAll('#home .select-box .options-container');
const listOverlay = document.querySelector('.playfield_overview .listOverlay');
const allSelectedbox = document.querySelectorAll('#home .select-box .selected');
...
const optionLabel = document.querySelectorAll('#home .inside_option .option label');
const optionInput = document.querySelectorAll('#home .inside_option .option input');
...
let sportArray = [], stateArray = [], boxCon, dir = 'desc', ownertext = [], sporttext = [];
